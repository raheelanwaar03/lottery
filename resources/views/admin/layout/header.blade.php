            ...
            <div class="navbar-content">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu"><a href="#!" class="pc-link"><span class="pc-micon"><svg
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/admins/course-dashboard.html">All Users</a></li>
                        </ul>
                    </li>
                    <li class="pc-item pc-hasmenu"><a href="#!" class="pc-link"><span class="pc-micon"><svg
                                    class="pc-icon">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item"><a class="pc-link" href="{{ route('Admin.All.Lottery') }}">ALL</a></li>
                        </ul>
                    </li>
                    {{-- <li class="pc-item pc-hasmenu"><a href="#!" class="pc-link"><span class="pc-micon"><svg
                                    class="pc-icon">
                        ...
                        <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                            <div class="dropdown-header d-flex align-items-center justify-content-between">
                                <h5 class="m-0">Notifications</h5><a href="#!"
                                    class="btn btn-link btn-sm">Mark all
                                    read</a>
                            </div>
                                ...
                                <div class="profile-notification-scroll position-relative"
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Carson Darrin 🖖</h6><span><a
                                                    ...
                                                    class="__cf_email__"
                                                    data-cfemail="b5d6d4c7c6dadb9bd1d4c7c7dcdbf5d6dad8c5d4dbcc9bdcda">[email&#160;protected]</a></span>
                                        </div>
                                    </div>
                                    ...
                                    <p class="text-span">Team</p><a href="#"
                                        ...
                                        <div class="user-group"><img
                                                src="{{ asset('admin/asset/images/user/avatar-1.jpg') }}"
                                    ...
                                    <div class="card border-0 shadow-none drp-upgrade-card mb-0"
                                        ...
                                        <div class="card-body">
                                            <div class="user-group"><img
                                                    ...
                                                    src="{{ asset('admin/asset/images/user/avatar-2.jpg') }}"
                                                    alt="user-image" class="avtar"> <img
                                                    src="{{ asset('admin/asset/images/user/avatar-3.jpg') }}"
                                                    alt="user-image" class="avtar"> <img
                                                    src="{{ asset('admin/asset/images/user/avatar-4.jpg') }}"
                                                    alt="user-image" class="avtar"> <img
                                                    src="{{ asset('admin/asset/images/user/avatar-5.jpg') }}"
                                                    alt="user-image" class="avtar"> <span
